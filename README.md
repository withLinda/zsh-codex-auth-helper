...
- `CodexAuthHelper-v2026.05.28.1.dmg`
...
- `CodexAuthHelper-v2026.05.28.1.dmg.sha256`
...
The DMG is not notarized. On first launch, macOS may show a warning. If that happens, right-click `Codex Auth Helper`, choose **Open**, then choose **Open** again.
